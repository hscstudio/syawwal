...
class StudentSearch extends Student
{
    ...
    public function rules()
    {
        return [
            ...
            [['name', 'nickName', 'frontTitle', 'backTitle', 'nip', 'password_hash', 'auth_key', 'born', 'birthDay', 'phone', 'email', 'address', 'photo', 'blood', 'position', 'education', 'eselon2', 'eselon3', 'eselon4', 'satker', 'officePhone', 'officeFax', 'officeEmail', 'officeAddress', 'noSKPangkat', 'tmtSKPangkat', 'fileSKPangkat', 'created', 'modified', 'deleted'], 'safe'],
        ];
    }
