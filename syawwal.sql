...
--
-- Host: localhost
-- Generation Time: Aug 20, 2014 at 10:19 AM
...
--
-- Indexes for table `tb_program_document_history`
--
ALTER TABLE `tb_program_document_history`
 ADD PRIMARY KEY (`tb_program_document_id`,`tb_program_id`,`revision`), ADD KEY `fk_tb_program_document_tb_program1` (`tb_program_id`);
...
--
-- Indexes for table `tb_program_subject_document_history`
--
