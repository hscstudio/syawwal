...
--
-- Host: localhost
-- Generation Time: Aug 20, 2014 at 05:55 PM
...
(4, 3, '2.2.1.0', 'PRANATA KOMPUTER AHLI', NULL, NULL, 0, 0, '', 0, '', 1, '2014-08-20 09:42:32', 1, '2014-08-20 16:00:26', 1, NULL, NULL);
...
(3, 4, 0, 'HALO', 'GBPP', '53f415ef836fb.pdf', '', 1, '2014-08-20 10:28:47', 1, '2014-08-20 16:50:18', 1, NULL, NULL);
...
(1, 1, 0, 'Bahan Ajar', 'Oke', '53f44c7b05874.pdf', '', 1, '2014-08-20 14:21:31', 1, '2014-08-20 17:04:25', 1, NULL, NULL),
(2, 1, 0, 'CMS', 'Oke', '53f45af108653.pdf', '', 1, '2014-08-20 15:23:13', 1, '2014-08-20 15:23:13', 1, NULL, NULL),
(3, 1, 1, 'Hahahahaah', 'Ok', '53f4641190ebe.pdf', '', 1, '2014-08-20 16:02:09', 1, '2014-08-20 16:02:09', 1, NULL, NULL);
...
(1, 'admin', 'admin@gmail.com', '$2y$13$xOnFV4B5NGTJpu1P/qy03Owrkx6j/35dZJR6gPNscLSV2A6kR98fa', '_ZSeDwI6bRSftr4iK42GukuBrWgvHjwz', NULL, NULL, 1405729304, NULL, NULL, NULL, NULL, '', 2130706433, 2130706433, 1408531975, 1405728264, 1408531975);
...
ALTER TABLE `tb_training_class`
 ADD PRIMARY KEY (`id`), ADD KEY `fk_tb_training_assignment_tb_training_subject1` (`tb_training`);
...
ALTER TABLE `tb_training_history`
 ADD PRIMARY KEY (`id`), ADD KEY `fk_tb_training_tb_program1` (`tb_program_id`), ADD KEY `fk_tb_training_ref_satker1` (`ref_satker_id`), ADD KEY `tb_training_id` (`tb_training_id`);
