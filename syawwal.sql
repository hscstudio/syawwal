...
--
-- Table structure for table `tb_global_pic`
--

CREATE TABLE IF NOT EXISTS `tb_global_pic` (
`id` int(3) NOT NULL COMMENT 'tb_pic = untuk menyimpan data pejabat misal PPK, KAPUS, dsb',
  `employee_id` int(11) NOT NULL,
  `object` varchar(255) NOT NULL COMMENT 'PUSDIKLAT: KAPUS,KPA,PPK,BENDAHARA##BDK:KABDK,KPA,PPK,BENDAHARA##PSDM:KAPUS,KPA,PPK,BENDAHARA',
...
(1, 41, 1, 5, '', '', '2.00', '2014-08-19 08:00:00', '2014-08-19 09:30:00', 1, 1, '2014-09-24 10:57:59', 1, '2014-09-24 10:57:59', 1, NULL, NULL),
(2, 41, 2, 5, '', '', '2.00', '2014-08-19 09:30:00', '2014-08-19 11:00:00', 1, 1, '2014-09-24 10:58:07', 1, '2014-09-24 10:58:07', 1, NULL, NULL);
...
INSERT INTO `tb_training_schedule_trainer` (`id`, `tb_training_schedule_id`, `tb_trainer_id`, `ref_trainer_type_id`, `hours`, `reason`, `cost`, `status`, `created`, `createdBy`, `modified`, `modifiedBy`, `deleted`, `deletedBy`) VALUES
(1, 1, 1, 0, NULL, NULL, NULL, 1, '2014-09-24 11:02:18', 1, '2014-09-24 11:02:18', 1, NULL, NULL);
...
(1, 'admin', 'admin@gmail.com', '$2y$13$xOnFV4B5NGTJpu1P/qy03Owrkx6j/35dZJR6gPNscLSV2A6kR98fa', '_ZSeDwI6bRSftr4iK42GukuBrWgvHjwz', NULL, NULL, 1405729304, NULL, NULL, NULL, NULL, '', 2130706433, 2130706433, 1411530945, 1405728264, 1411530945),
...
--
-- Indexes for table `spg_08_unit_organisasi`
--
ALTER TABLE `spg_08_unit_organisasi`
 ADD PRIMARY KEY (`ID`);
...
--
-- Indexes for table `tb_global_pic`
--
ALTER TABLE `tb_global_pic`
 ADD PRIMARY KEY (`id`), ADD UNIQUE KEY `code_UNIQUE` (`object`);
...
ALTER TABLE `tb_relation`
 ADD PRIMARY KEY (`id`), ADD KEY `fk_tb_training_pic_tb_training1` (`object`), ADD KEY `fk_tb_training_pic_tb_admin1` (`object_id`);
...
ALTER TABLE `tb_training_class_student`
 ADD PRIMARY KEY (`id`), ADD UNIQUE KEY `tb_training_id_2` (`tb_training_id`,`tb_training_student_id`), ADD KEY `fk_tb_training_subject_student_tb_training_assignment1` (`tb_training_class_id`), ADD KEY `fk_tb_training_subject_student_tb_student1` (`tb_training_student_id`), ADD KEY `tb_training_id` (`tb_training_id`);

--
-- Indexes for table `tb_training_class_student_attendance`
--
ALTER TABLE `tb_training_class_student_attendance`
 ADD PRIMARY KEY (`id`), ADD KEY `tb_training_schedule_id` (`tb_training_schedule_id`), ADD KEY `tb_training_class_student_id` (`tb_training_class_student_id`);

--
-- Indexes for table `tb_training_class_student_certificate`
--
ALTER TABLE `tb_training_class_student_certificate`
 ADD PRIMARY KEY (`tb_training_class_student_id`), ADD KEY `fk_tb_training_certificate_tb_training1` (`tb_training_class_student_id`), ADD KEY `fk_tb_training_certificate_ref_unit1` (`ref_unit_id`), ADD KEY `fk_tb_training_certificate_ref_graduate1` (`ref_graduate_id`), ADD KEY `fk_tb_training_certificate_ref_rank_class1` (`ref_rank_class_id`);
...
ALTER TABLE `tb_training_class_subject_trainer_evaluation`
 ADD PRIMARY KEY (`id`), ADD KEY `fk_tb_training_trainer_evaluation_tb_student1` (`tb_student_id`), ADD KEY `tb_training_class_subject_id` (`tb_training_class_subject_id`);
...
ALTER TABLE `tb_training_student`
 ADD PRIMARY KEY (`id`), ADD KEY `fk_tb_training_assignment_tb_training_subject1` (`tb_training_id`), ADD KEY `tb_student_id` (`tb_student_id`);
...
--
-- AUTO_INCREMENT for table `spg_08_unit_organisasi`
--
ALTER TABLE `spg_08_unit_organisasi`
...
--
-- AUTO_INCREMENT for table `tb_global_pic`
--
ALTER TABLE `tb_global_pic`
...
--
ALTER TABLE `tb_message`
MODIFY `id` bigint(33) NOT NULL AUTO_INCREMENT;
--
