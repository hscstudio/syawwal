...
<div class="employee-view">
    ...
    <?= DetailView::widget([
        ...
        'attributes' => [			 
			...
			[
				'attribute' => 'gender',
				'value' => $model->gender == '0'?'Pria':'Wanita',
			],
            'phone',
            'email:email',
            'address',
			[
				'attribute' => 'married',
				'value' => $model->married == '0'?'Belum Menikah':'Menikah',
			],
			[
				'attribute' => 'photo',
				'format' => 'html',
				'value' => '<img src='.\yii\helpers\Url::to(['/file/download','file'=>'employee/'.$model->id.'/'.$model->photo]).'>',
				/*'attribute' => 'photo',
				'format' => 'image',
