...
<div class="training-unit-plan-index">
    ...
    <?= GridView::widget([
            ...
            /*
				...
				*/
				...
				[
					...
					'editableOptions'=>['header'=>'Spread', 'size'=>'md','formOptions'=>['action'=>\yii\helpers\Url::to('editable')]]
				],
				...
				[
					...
					'headerOptions'=>['class'=>'kv-sticky-column'],
					'contentOptions'=>['class'=>'kv-sticky-column'],
					'editableOptions'=>['header'=>'Total', 'size'=>'md','formOptions'=>['action'=>\yii\helpers\Url::to('editable')]]
				],
		...
		'panel' => [
			//'heading'=>'<h3 class="panel-title"><i class="fa fa-fw fa-globe"></i> Training Unit Plan</h3>',
