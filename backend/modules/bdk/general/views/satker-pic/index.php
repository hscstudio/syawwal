...
/* @var $searchModel backend\models\SatkerPicSearch */
/* @var $dataProvider yii\data\ActiveDataProvider */

$this->title = 'Satker Pics';
...
?>
<div class="satker-pic-index">

    <!-- <h1><?= Html::encode($this->title) ?></h1> -->
    <?php // echo $this->render('_search', ['model' => $searchModel]); ?>
	<!--
    <p>
        <?= Html::a('Create Satker Pic', ['create'], ['class' => 'btn btn-success']) ?>
    </p>
	-->
    <?= GridView::widget([
		...
		'panel' => [
			//'heading'=>'<h3 class="panel-title"><i class="glyphicon glyphicon-globe"></i> Satker Pic</h3>',
			'heading'=>'<h3 class="panel-title"><i class="glyphicon glyphicon-globe"></i></h3>',
			//'type'=>'primary',
			'before'=>Html::a('<i class="glyphicon glyphicon-plus"></i> Create Satker Pic', ['create'], ['class' => 'btn btn-success']),
