...
$this->params['breadcrumbs'][] = ['label'=>'Program','url'=>['program3/index']];
...
<div class="program-subject-index">
    ...
    <?= GridView::widget([
		...
		'panel' => [
			...
			//'type'=>'primary',
			'before'=>
			Html::a('<i class="fa fa-fw fa-arrow-left"></i> Back To Program', ['program3/index'], ['class' => 'btn btn-warning']).' '.
			...
			Select2::widget([
				...
				'options' => [
					...
					'class'=>'form-control', 
					'onchange'=>'
						$.pjax.reload({url: "'.\yii\helpers\Url::to(['/'.$controller->module->uniqueId.'/program-subject3/index']).'?tb_program_id='.(int)$tb_program_id.'&status="+$(this).val(), container: "#pjax-gridview", timeout: 1});
					',	
					'data-pjax' => '1',
				],
			]).
