...
/* @var $searchModel backend\models\TrainingClassStudentAttendanceSearch */

$this->title = 'Training Class Student Attendances';
...
?>
<div class="training-class-student-attendance-index">
    ...
    <?= GridView::widget([
        ...
        'columns' => [
            ...
            /*
				[
					...
					'value' => function ($data) {
						return $data->trainingSchedule->name;
					}
				],
				*/
            /*
		...
		'panel' => [
			//'heading'=>'<h3 class="panel-title"><i class="fa fa-fw fa-globe"></i> Training Class Student Attendance</h3>',
			'heading'=>'<h3 class="panel-title"><i class="fa fa-fw fa-globe"></i></h3>',
			//'type'=>'primary',
			'before'=>Html::a('<i class="fa fa-fw fa-plus"></i> Create Training Class Student Attendance', ['create'], ['class' => 'btn btn-success']),
