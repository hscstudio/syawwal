...
?>
<div class="training-class-student-attendance-view">

    <?= DetailView::widget([
        'model' => $model,
		'mode'=>DetailView::MODE_VIEW,
		'panel'=>[
			'heading'=>'<i class="fa fa-fw fa-globe"></i> '.'Training Class Student Attendances # ' . $model->id,
        ...
        'attributes' => [
            ...
            [
				...
				'value' => $model->trainingSchedule->name,
			],
