			...
			if(!empty($importFile)){
				...
				if(in_array($ext,$fileTypes)){
					...
					while(!empty($sheetData[$baseRow]['A'])){
						...
						$education=  $sheetData[$baseRow]['U'];
						$eselon2=  $sheetData[$baseRow]['V'];
						$eselon3=  $sheetData[$baseRow]['W'];
						$eselon4=  $sheetData[$baseRow]['X'];
						$officePhone=  $sheetData[$baseRow]['Y'];
						$officeFax=  $sheetData[$baseRow]['Z'];
						$officeEmail=  $sheetData[$baseRow]['AA'];
						$officeAddress=  $sheetData[$baseRow]['AB'];
						$noSKPangkat=  $sheetData[$baseRow]['AC'];
						$tmtSKPangkat=  $sheetData[$baseRow]['AD'];
						$fileSKPangkat=  $sheetData[$baseRow]['AE'];
						$status=  $sheetData[$baseRow]['AF'];
						//$created=  $sheetData[$baseRow]['AG'];
						//$createdBy=  $sheetData[$baseRow]['AH'];
						//$modified=  $sheetData[$baseRow]['AI'];
						//$modifiedBy=  $sheetData[$baseRow]['AJ'];
						//$deleted=  $sheetData[$baseRow]['AK'];
						//$deletedBy=  $sheetData[$baseRow]['AL'];
